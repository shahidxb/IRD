...
const subcat_service_1 = require("./subcat.service");
exports.SubCategoriesControllers = {
    getSubCategories: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const result = yield subcat_service_1.SubCategoriesService.fetchSubCategories({
            page,
            limit,
            all,
        });
        const { total } = result, sub_categories = __rest(result, ["total"]);
